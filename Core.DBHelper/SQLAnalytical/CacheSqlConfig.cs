...
using Core.DBHelper.Helper;
using Core.DBHelper.Models;
using Core.DBHelper.Utilities;
using System;
using System.Collections.Generic;
using System.IO;
using System.Xml;

namespace Core.DBHelper.SQLAnalytical
{
    public class CacheSqlConfig
    {
        ...
        public string SqlConfigPath
        {
            get
            {
                ...
                {
                    _sqlConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory + "bin", "SqlConfig");
                }
                if (!Directory.Exists(_sqlConfigPath))
                {
                    _sqlConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory + "SqlConfig");
                }
                if (!Directory.Exists(_sqlConfigPath))
                {
